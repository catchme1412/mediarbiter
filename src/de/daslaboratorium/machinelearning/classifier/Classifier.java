...
public abstract class Classifier<T, K> implements IFeatureProbability<T, K> {
	 ...
	 * known category.
	 */
	private Map<K, HashMap<T, Integer>> featureCountPerCategory;
	 ...
	 */
	public void reset() {
		this.featureCountPerCategory = new HashMap<K, HashMap<T, Integer>>();
	...
	public void incrementFeature(T feature, K category) {
		...
		features = features != null ? features : new HashMap<T, Integer>();
